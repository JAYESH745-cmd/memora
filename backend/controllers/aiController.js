  ...
  try {
    ...
    const flashcardSet=await Flashcard.create({
        ...
        cards:cards.map(card=>({
            ...
            answer:card.answer,
            difficult:card.difficulty || card.difficult || "medium",
            reviewCount:0,
            isStarred:false
...
export const generateQuiz = async (req, res, next) => {
  try {
    const { documentId, numQuestions = 7, title } = req.body;
...
export const chat = async (req, res, next) => {
  try {
    ...
    // console.log("Chunks type:", Array.isArray(document.chunks));
    // console.log("Chunks length:", document.chunks?.length);
    // console.log("First chunk:", document.chunks?.[0]);
